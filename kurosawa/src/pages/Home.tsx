  ...
  return (
    <div className={styles.pageBg}>
        ...
        <AnimatePresence mode="wait">
            {isFortiesActive &&
            <>
            <motion.div variants={decadeImageFade} initial="initial" animate="enter" exit="exit" className={styles.backgroundImage}>
                <video className={styles.fortyVideo} autoPlay playsInline muted loop draggable="false"><source src={forty}/></video>
            </motion.div>
        ...
        <AnimatePresence mode="wait">
            ...
            <>
                <div className={styles.backgroundImage}>
                    <video className={styles.fiftyVideo} autoPlay playsInline muted loop draggable="false"><source src={fifty}/></video></div>
        ...
        <AnimatePresence mode="wait">
            ...
            <>
                <div className={styles.backgroundImage}>
                    <video className={styles.sixtyVideo} autoPlay playsInline muted loop draggable="false"><source src={sixty} /></video>
                </div>
        ...
        <AnimatePresence mode="wait">
            ...
            <>
                <motion.div variants={decadeImageFade} initial="initial" animate="enter" exit="exit" className={styles.backgroundImage}>
                    <video className={styles.restVideo} autoPlay playsInline muted loop draggable="false"><source src={rest}/></video>
                </motion.div>
